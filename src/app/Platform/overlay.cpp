...
static void LoadVisualsUiIconTextures()
{
    ...
    loadIcon(VisualsUiIconSlot::WorldVisuals, world_visuals_rle, sizeof(world_visuals_rle), g::visualsUiIcons.worldVisuals);
    loadIcon(VisualsUiIconSlot::BombVisuals, bomb_visuals_rle, sizeof(bomb_visuals_rle), g::visualsUiIcons.bombVisuals);
}

    ...
    uint16_t previewLocalGrenadeIds[visuals::PlayerData::kMaxGrenades] = {};
    memcpy(previewLocalGrenadeIds, s_localGrenadeIds, sizeof(previewLocalGrenadeIds));
    int previewLocalGrenadeCount = std::clamp(s_localGrenadeCount, 0, visuals::PlayerData::kMaxGrenades);

            ...
            try {
                ...
                if (dmaRecoveringNow || dmaRecoveryRequestedNow) {
                    ...
                    if (gotMatrix)
                        ...
                        if (consecutiveViewMisses == kCameraInvalidateMissThreshold)
                            DmaLogPrintf("[WARN] CameraWorker: view matrix read failing (miss=%u)", consecutiveViewMisses);
                    }
                    ...
                    if (gotLocalPos)
                        ...
                        if (consecutiveLocalPosMisses == kCameraInvalidateMissThreshold)
                            DmaLogPrintf("[WARN] CameraWorker: local pos read failing (miss=%u)", consecutiveLocalPosMisses);
                    }

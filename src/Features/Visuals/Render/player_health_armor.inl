...
const float armorBarLeft = g::visualsHealth ? (healthBarLeft - armorBarWidth - armorBarGap) : healthBarLeft;
...
if (g::visualsArmor) {
    ...
    if (g::visualsArmorText && p.armor > 0 && p.armor < 100) {
        makeBarLabel(
            apLabel,
            p.armor,
            armorBarLeft,
...
if (g::visualsHealth) {
    ...
    if (g::visualsHealthText && p.health < 100) {
        makeBarLabel(
            hpLabel,
            p.health,
            healthBarLeft,

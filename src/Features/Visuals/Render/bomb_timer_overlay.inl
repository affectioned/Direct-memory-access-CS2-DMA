if (g::visualsBombInfo && g::visualsBombTime) {
    ...
    static float s_defuseDisplayedTotal = visuals::style::kBombDefuseNoKitSeconds;
    ...
    const float defuseTotalFromState =
        ...
        bombState.defuseLength <= 15.0f
            ...
            : visuals::style::kBombDefuseNoKitSeconds;
    ...
    if (liveTimerVisible && !timerSuppressed) {
        ...
        if (bombState.beingDefused) {
            ...
            s_prevDefusing = false;
            s_defuseDisplayedLeft = 0.0f;
            s_defuseDisplayedTotal = visuals::style::kBombDefuseNoKitSeconds;
        }
        ...
        g::visualsBombTimerX = std::clamp(g::visualsBombTimerX, 0.0f, std::max(0.0f, screenW - 230.0f));
        g::visualsBombTimerY = std::clamp(g::visualsBombTimerY, 0.0f, std::max(0.0f, screenH - 90.0f));
        ImGui::SetNextWindowPos(ImVec2(g::visualsBombTimerX, g::visualsBombTimerY), ImGuiCond_Always);
        ...
        if (ImGui::Begin("##kevqdma_bomb_timer", nullptr, windowFlags)) {
            ...
            if (g::menuOpen) {
                ...
                if (s_bombTimerDragging && ImGui::IsMouseDown(ImGuiMouseButton_Left)) {
                    ...
                    g::visualsBombTimerX += delta.x;
                    g::visualsBombTimerY += delta.y;
                    ImGui::SetWindowPos(ImVec2(g::visualsBombTimerX, g::visualsBombTimerY), ImGuiCond_Always);
